# Generated by Django 5.0.2 on 2025-12-01 15:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel', models.CharField(default=None, max_length=10)),
                ('adresse', models.CharField(default=None, max_length=80)),
                ('bloque', models.BooleanField(default=False)),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('client', 'Client'), ('vendeur', 'Vendeur')], max_length=15)),
